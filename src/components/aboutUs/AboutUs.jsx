    ...
    <>
      ...
      <Container>
        ...
        <Typography textAlign="start" fontSize="15px" variant="h5" pt="10px">
          ...
          related between them, we have currently created strong ties to pursue
          & achieve our main goal, to get better in the IT Development world.
          This will help us renew our job careers sharing knowledge, ideas, etc.
        </Typography>
      </Container>
      <Box>
        <Typography
