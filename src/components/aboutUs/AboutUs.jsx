    ...
    <>
        ...
        <Grid Container spacing={2}>
          <Grid Item sm={6} md={6}>
            ...
            >
              ...
              respective previous fields. Despite of these past studies not
              having anything related between them, we have currently created
              strong ties to pursue & achieve our main goal, to get better in
              the IT Development world. This will help us renew our job careers
              sharing knowledge, ideas, etc.
            </Typography>
          </Grid>
          <Grid Item sm={6} md={6}>
            <Typography
      ...
      <Container>
        ...
        >
          ...
          which motivated us to design a MER in Figma. Later on, we started the
          project following the MER and the to do list implemented in Trello.
          ...
          elements. All details and functionalities implemented were the team's
      ...
      >
        <Card sx={cardStyles}>
          <CardContent>
            ...
            <Typography pt="10px" variant="body2">
              Our main challenge was created and designed the whole web site
              only in 3 weeks.
            </Typography>
          </CardContent>
        </Card>
        <Card sx={cardStyles}>
          <CardContent>
            ...
            <Typography pt="10px" variant="body2">
              We assigned a sprint per week and we follow the trello pending
              lists to complice correctly the corresponding sprint.
            </Typography>
          </CardContent>
        </Card>
        <Card sx={cardStyles}>
          <CardContent>
            ...
            <Box display="flex" variant="body2">
              <br />
              <Box>
                <ListItem>
      ...
      >
        <Box>
          ...
          <Typography sx={{ fontSize: "13px", fontWeight: "600", pb: "10px" }}>
